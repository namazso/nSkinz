...
namespace hooks
{
	...
	extern void __fastcall FrameStageNotify(IBaseClientDLL* thisptr, void*, ClientFrameStage_t stage);

	// IGameEventManager2

	using FireEventClientSide_t = bool(__thiscall *)(IGameEventManager2*, IGameEvent*);

	extern bool __fastcall FireEventClientSide(IGameEventManager2* thisptr, void*, IGameEvent* event);
